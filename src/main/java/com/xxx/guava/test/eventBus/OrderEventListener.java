...
public class OrderEventListener {
  ...
  public void dealWithEvent(OrderMessage event) {
    ...
    System.out.println("OrderEventListener收到了您的命令，命令内容为：" + event.getOrderContent());
  }

  @Subscribe
  public void dealWithStringEvent(String event) {
    // TODO: 收到EventTest消息之后，做相应的处理
    System.out.println("OrderEventListener--String收到了您的命令，命令内容为：" + event);
  }

  @Subscribe
  public void dealWithStringEventTwo(String event) {
    // TODO: 收到EventTest消息之后，做相应的处理
    System.out.println("OrderEventListener--dealWithStringEventTwo收到了您的命令，命令内容为：" + event);
  }
}
